					...
					<div class="product-details"><!--product-details-->
						...
						<div class="col-sm-7">
							<div class="product-information"><!--/product-information-->
								...
								<p><select name="size" id="selsize"style="width :150px">
								<option value="">SELECT SIZE</option>
								@foreach($product->attributes as $siz)
							    <option id="size{{$siz->id}}" name="size" value="{{$product->id}}-{{$siz->size}}">{{$siz->size}}</option>
								  @endforeach
								</select>
								<span>
									<span id ="productprice" value="{{$product->Price}}">
									...
									<a href=""><button type="submit" class="btn btn-fefault cart">
								...
								{{-- <div class="" style="margin-top: 19px; margin-right: 341px;"> --}}
								 @foreach($pro as $item) 
								 <div class="col-md-2" >
                                    <div class="thumbnail" style="width: 60px;height: 89px;margin-top: 14px;">
								        <a href="{{url('fproduct/'.$item->product_id)}}" >
								          <img src="{{asset("upload/".$item->image)}}" alt="Nature" height="40" width="40">
								          <div class="caption" >
								           <p style="text-align: center;">{{$item->Product_color}}</p>
								          </div>
								        </a>
								      </div>
								   </div>
